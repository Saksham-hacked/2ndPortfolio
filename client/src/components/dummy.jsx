...
//     const isSessionInTT = sessionsWithTT.includes(session);
//     return(  
...
//     <Td>
//             <Button
//               colorScheme={isSessionInTT ? "green" : "gray"}
//               onClick={() => handleSetCurrentSession(session)}
//               isDisabled={!isSessionInTT} // Disable if not in sessionsWithTT
//             >
//               {isSessionInTT ? "Set as Current" : "Unavailable"}
//             </Button>
//           </Td>
//   </Tr>
// )}
